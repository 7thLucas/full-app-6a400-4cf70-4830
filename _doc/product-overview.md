...
- Reduce cognitive load — all complexity is held by the app, not pushed to the user
- Surface what matters before it becomes urgent
- Treat the user as capable and in control, not as a patient to be managed
- One view covers everything — no bouncing between tools or notes
- Appointment changes are first-class events — the app expects them and handles them gracefully
