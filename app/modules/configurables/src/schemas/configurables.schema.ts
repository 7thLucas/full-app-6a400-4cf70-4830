...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "personInCareName",
      type: "string",
      required: false,
      label: "Person in Care — Name",
      maxLength: 60,
    },
    {
    ...
    {
      fieldName: "emptyDayMessage",
      type: "string",
      required: false,
      label: "Empty Day Message",
      maxLength: 160,
    },
    {
      fieldName: "readyBufferMinutes",
      type: "number",
      required: false,
      label: "Get-Ready Buffer (minutes before departure)",
      min: 0,
      max: 240,
    },
    {
      fieldName: "referralExpiryWarningDays",
      type: "number",
      required: false,
      label: "Referral Expiry Warning (days ahead)",
      min: 1,
      max: 120,
    },
    {
      fieldName: "showTravelContext",
      type: "boolean",
      required: false,
      label: "Show Live Travel Context",
    },
    {
      fieldName: "showFinancialValue",
      type: "boolean",
      required: false,
      label: "Show Tax / Receipt Value Card",
    },
    {
